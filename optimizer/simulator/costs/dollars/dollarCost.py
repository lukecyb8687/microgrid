...
def dollarCost(gridComponents, timeStep, loadVector, projectDuration, discountRate, strategy, dispatchingResult):
    """
    INPUTS :
        - gridComponents : 
                            {
...
#                 gridComponents["diesel"]["fuelCostIntercept"])
    ...
    dg = dgCost(generatorPowerVector, discountRate, timeVariables, costVariables, fuelVariables)
