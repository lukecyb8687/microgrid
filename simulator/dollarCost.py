...
def dollarCost(gridComponents, timeStep, loadVector, projectDuration, discountRate, strategy):
        ...
        - gridComponents : 
                            {
                                ...
                                "diesel" : {
                                                ...
                                                "powerTimeVector": numpy array, the power output of the dg at each time step (kW)
                                            },
                                "photovoltaic" : {
   ...
   OUTPUTS :
    ...
    pvPowerVector = gridComponents["photovoltaic"]["powerTimeVector"]
    ...
    # PV COST
    pv = pvCost(gridComponents["photovoltaic"]["powerTimeVector"],
                 projectDuration/(24 * 365),
